...
running command...
$ mynewcli (--version)
mynewcli/0.0.0 darwin-arm64 node-v16.19.0
...
_See code: [dist/commands/hello/index.ts](https://github.com/cli/mynewcli/blob/v0.0.0/dist/commands/hello/index.ts)_
...
_See code: [dist/commands/hello/world.ts](https://github.com/cli/mynewcli/blob/v0.0.0/dist/commands/hello/world.ts)_
